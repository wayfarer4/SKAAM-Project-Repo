...
INSERT INTO Incident(IncidentId, IncidentType, IncidentTime, IncidentName, CleanerId) VALUES
 (3768394409,'#bbb','2023-05-31','Lost Notebook',8638527),
 (3649664054,'#3e3','2023-12-16','Broken Chair',5018295538),
 (4958206841,'#060','2023-09-15','Spilled Coffee',2223827004),
 (6853157621,'#ade','2023-12-16','Printer Jam',6836057703),
 (6998129114,'#284','2025-04-19','Locked Door',4191294111),
 (3196185060,'#017','2023-05-14','Flickering Light',3756300196),
 (4138740422,'#103','2023-06-01','Sticky Keyboard',106886290),
 (5135356282,'#594','2024-01-27','Clogged Sink',8643583107),
 (4155762846,'#140','2025-01-24','Scratched Desk',8643583107),
 (6603291428,'#e92','2025-09-13','Broken Window',4979887918),
 (1322692521,'#ae1','2023-12-17','Leaky Faucet',106886290),
 (2029530840,'#bde','2025-07-24','Paper Jam',4979887918),
 (1481631632,'#c10','2023-04-21','Loose Doorknob',3756300196),
 (0912529814,'#d6c','2023-09-04','Broken Clock',2022841034),
 (3855819009,'#2b0','2023-07-25','Faded Poster',4127181009),
 (4605716106,'#04d','2024-08-17','Stained Carpet',4127181009),
 (4229826036,'#3a1','2024-09-22','Dusty Bookshelf',4996835660),
 (5368093977,'#991','2023-05-26','Missing Stapler',3542953303),
 (2817490576,'#be0','2023-08-14','Noisy AC Unit',3202960471),
 (8656318934,'#500','2023-09-11','Cracked Mirror',2027418421),
 (2061308279,'#0d8','2023-11-02','Jammed Drawer',7944751683),
 (3652790324,'#258','2023-05-05','Tangled Cables',7944751683),
 (9435901107,'#435','2025-09-12','Smudged Whiteboard',4613241729),
 (8621461846,'#709','2023-11-15','Wobbly Table',6836057703),
 (7326339988,'#d22','2023-06-28','Overflowing Trashcan',8843686508),
 (2698345209,'#21c','2024-09-13','Squeaky Door',4979887918),
 (8751083620,'#c3e','2023-06-21','Missing Plant',106886290),
 (8573105798,'#418','2024-08-16','Flickering Bulb',6815592292),
 (5516151023,'#72e','2024-04-22','Loose Floor Tile',6759514211),
 (8339177613,'#4d8','2024-05-27','Scratched Wall',3756300196),
 (1085541274,'#4aa','2025-03-09','Broken Ruler',106886290),
 (1926598032,'#eee','2025-07-11','Misplaced Key',987971928),
 (4425713893,'#b30','2025-09-04','Dirty Window',6836057703),
 (7223094915,'#b65','2024-02-18','Creaky Chair',3045876257),
 (2917723157,'#a8b','2025-08-20','Wet Floor',8338968475),
 (0192785249,'#7d0','2023-06-15','Torn Poster',7868533179),
 (8789906810,'#2f3','2024-08-24','Broken Lock',6088504651),
 (5858890806,'#a55','2024-09-11','Smudged Screen',7939758345),
 (9849669497,'#2b1','2024-12-08','Malfunctioning Mouse',3756300196),
 (9664490342,'#3a8','2024-11-14','Loud Printer',4613241729),
 (4669276646,'#c6d','2025-07-03','Dusty Vent',9469268713),
 (5137525618,'#f41','2024-08-07','Scuffed Floor',5361691259),
 (5190506711,'#4d3','2025-04-11','Broken Mirror',6759514211),
 (8828311983,'#bce','2024-01-06','Clogged Toilet',5848394219),
 (6939044329,'#445','2024-08-20','Torn Upholstery',7638641392),
 (2006427644,'#87c','2023-07-20','Wobbly Shelf',5018295538),
 (3488863727,'#083','2023-10-01','Damaged Whiteboard',8638527),
 (1130188655,'#f2c','2024-01-01','Spilled Water',3631701752),
 (4729584201,'#3da','2023-04-30','Wet Carpet',9925227965),
 (9362795973,'#2fd','2023-11-29','Squeaky Chair',1085541274),
 (1402397186,'#9b1','2024-06-28','Broken Window Blind',3756300196),
 (3674412357,'#a59','2024-12-14','Dusty Keyboard',2002718989),
 (4444147393,'#417','2025-05-13','Sticky Mouse',2022841034),
 (3009311133,'#527','2023-07-26','Worn-out Chair',8269174389),
 (0138157413,'#18e','2023-05-04','Jam in Copier',1322692521),
 (3800001756,'#692','2024-12-15','Scratched Desk Surface',8643583107),
 (8815294082,'#11b','2023-06-09','Broken Headphone',7944751683),
 (9249589476,'#eb2','2024-05-28','Damaged Bookshelf',4979887918),
 (1036425681,'#a83','2023-10-07','Stained Ceiling',6228024211),
 (6303617115,'#29d','2023-08-01','Worn-out Carpet',8911930821);
